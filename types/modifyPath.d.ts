...
export function modifyPath<U>(path: [], fn: (value: U) => U, obj: U): U;
export function modifyPath<U, T>(path: [], fn: (value: U) => T, obj: U): T;
export function modifyPath<K0 extends keyof U, U>(path: [K0], fn: (value: U[K0]) => U[K0], obj: U): U;
...
export function modifyPath<
  ...
  U
>(path: [K0, K1], fn: (value: U[K0][K1]) => U[K0][K1], obj: U): U;
export function modifyPath<
  K0 extends keyof U,
  K1 extends keyof U[K0],
  U,
...
export function modifyPath<
  ...
  U
>(path: [K0, K1, K2], fn: (value: U[K0][K1][K2]) => U[K0][K1][K2], obj: U): U;
export function modifyPath<
  K0 extends keyof U,
  K1 extends keyof U[K0],
  K2 extends keyof U[K0][K1],
...
export function modifyPath<
  ...
  U
>(path: [K0, K1, K2, K3], fn: (value: U[K0][K1][K2][K3]) => U[K0][K1][K2][K3], obj: U): U;
export function modifyPath<
  K0 extends keyof U,
  K1 extends keyof U[K0],
  K2 extends keyof U[K0][K1],
...
export function modifyPath<
  ...
  U
>(path: [K0, K1, K2, K3, K4], fn: (value: U[K0][K1][K2][K3][K4]) => U[K0][K1][K2][K3][K4], obj: U): U;
export function modifyPath<
  K0 extends keyof U,
  K1 extends keyof U[K0],
  K2 extends keyof U[K0][K1],
...
export function modifyPath<
  ...
  U
>(path: [K0, K1, K2, K3, K4, K5], fn: (value: U[K0][K1][K2][K3][K4][K5]) => U[K0][K1][K2][K3][K4][K5], obj: U): U;
export function modifyPath<
  K0 extends keyof U,
  K1 extends keyof U[K0],
  K2 extends keyof U[K0][K1],
...
export function modifyPath<
  ...
  U
>(path: [K0, K1, K2, K3, K4, K5, K6], fn: (value: U[K0][K1][K2][K3][K4][K5][K6]) => U[K0][K1][K2][K3][K4][K5][K6], obj: U): U;
export function modifyPath<
  K0 extends keyof U,
  K1 extends keyof U[K0],
  K2 extends keyof U[K0][K1],
